...
declare -r LOGDIR='./experiment-data'  # all relative paths are relative to $LOGDIR
declare -r DATADIR="./experiment-inputs/control-SP/$APPLICATION"
declare -r OUTPUTDIR="./experiment-data/PI-control/$APPLICATION"
