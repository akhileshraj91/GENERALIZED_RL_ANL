...
def generate_data(experiment_dir,cluster):
    traces = {}
    ...
    for trace in traces[cluster][0]:
        try:
            ...
            print(f"{experiment_dir}{cluster}/{trace}")
    ...
    #### Uncomment the below 6 lines to store the data for later analysis.###
